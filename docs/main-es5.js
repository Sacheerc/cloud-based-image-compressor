...
var AddFilesComponent = /** @class */ (function () {
    ...
    AddFilesComponent.prototype.onFileSelect = function ($event) {
...
var CompressorComponent = /** @class */ (function () {
    function CompressorComponent(fileService, api) {
    ...
    CompressorComponent.prototype.ngOnInit = function () {
        ...
        this.fileService.isDownloadCompleted.subscribe(function (data) {
            _this.isDownloadCompleted = data;
        });
        this.fileService.compressedFiles.subscribe(function (data) {
            _this.isStarted = true;
            _this.fileName = _this.api.tempId;
            _this.value = data.length / _this.fileService.downloadedFiles.length * 100;
            if (data.length == _this.fileService.downloadedFiles.length) {
                _this.api.createZip(data).subscribe(function (result) {
                    console.log(result);
    ...
    CompressorComponent.prototype.downloadZip = function () {
        this.refresh = true;
        window.location.href = (this.url + '/images/zip/' + this.fileName + '.zip');
    };
    CompressorComponent.prototype.refreshReduzer = function () {
        window.location.reload();
    };
    CompressorComponent.ctorParameters = function () { return [
...
var FileListComponent = /** @class */ (function () {
    function FileListComponent(api, fileService) {
        this.api = api;
        this.fileService = fileService;
        this.imageArr = [];
    ...
    FileListComponent.prototype.ngOnInit = function () {
        ...
        this.imageArr.forEach(function (image) {
            _this.api.getImagesLocallyParallely(image.id).subscribe(function (resultImage) {
                image.status = "done";
                _this.downloadedFiles.push({
                    image_details: image,
                    image: resultImage,
                });
                _this.fileService.setDownloadedFiles(_this.downloadedFiles);
                _this.value =
                    (_this.downloadedFiles.length / _this.imageArr.length) * 100;
                if (_this.value == 100) {
                    _this.isDownloaded = true;
                    _this.fileService.isDownloadCompleted.emit(true);
                }
            }, function (error) {
                image.status = "failed";
            });
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.onFileSelect = function ($event) {
...
var downloadurl = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].uri + "/files/download";
var zipurl = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].uri + "/files/zip";
var fileurl = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].uri + "/files";
var compressurl = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].uri + "/files/compress";
var ApiService = /** @class */ (function () {
    function ApiService(httpClient) {
        this.httpClient = httpClient;
    }
    ApiService.prototype.getImage = function (id, name) {
        var data = {
            id: id,
            dir: this.tempId,
            name: name,
    ...
    ApiService.prototype.getImagesLocally = function (urlArray) {
        var _this = this;
        var forkArr = [];
        urlArray.forEach(function (item) {
            forkArr.push(_this.httpClient.get(item, { responseType: "blob" }));
        });
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])(forkArr);
    };
    ApiService.prototype.getImagesLocallyParallely = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            Authorization: "Bearer " + this.accessToken,
        });
        var url = "https://www.googleapis.com/drive/v2/files/" + id + "?alt=media";
        return this.httpClient.get(url, { headers: headers, responseType: "blob" });
    };
    ApiService.prototype.compressImages = function (image, quality) {
        var data = {
            image: image,
            quality: quality,
            dir: this.tempId,
    ...
    ApiService.prototype.createZip = function (images) {
        var data = {
            images: images,
            dir: this.tempId,
        };
    ...
    ApiService.prototype.getFile = function () {
...
var FileService = /** @class */ (function () {
    ...
    FileService.prototype.setDownloadedFiles = function (files) {
        this.downloadedFiles = files;
    };
    FileService.prototype.getDownloadedFiles = function () {
        return this.downloadedFiles;
    };
    FileService.prototype.setSelectedFiles = function (files) {
        this.selectedFiles = files;
    };
    FileService.prototype.getSelectedFiles = function () {
...
var GooglePickerComponent = /** @class */ (function () {
    function GooglePickerComponent(fileService, api) {
        this.fileService = fileService;
        this.api = api;
        this.selectedFiles = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    GooglePickerComponent.prototype.loadGoogleDrive = function () {
        gapi.load('auth', { 'callback': this.onAuthApiLoad.bind(this) });
        gapi.load('picker', { 'callback': this.onPickerApiLoad.bind(this) });
    };
    GooglePickerComponent.prototype.onAuthApiLoad = function () {
        var _this = this;
        gapi.auth.authorize({
            ...
            if (authResult && !authResult.error) {
                if (authResult.access_token) {
                    _this.api.tempId = authResult.issued_at;
                    _this.api.accessToken = authResult.access_token;
                    ...
                    var picker = pickerBuilder.
                        ...
                        if (e[google.picker.Response.ACTION] == google.picker.Action.PICKED) {
                            var docs = e[google.picker.Response.DOCUMENTS];
                            _this.fileService.setSelectedFiles(docs);
                            alert(_this.fileService.getSelectedFiles().length + " images are selected");
                            _this.selectedFiles.emit(docs);
                        }
                    }).
                        build();
    ...
    GooglePickerComponent.prototype.onPickerApiLoad = function () {
        this.pickerApiLoaded = true;
    };
    GooglePickerComponent.ctorParameters = function () { return [
        { type: src_app_services_file_service__WEBPACK_IMPORTED_MODULE_3__["FileService"] },
...
var ImageCompressComponent = /** @class */ (function () {
    function ImageCompressComponent(api, fileService, imageCompress) {
        var _this = this;
        this.api = api;
        this.fileService = fileService;
        ...
        this.downloadedFiles = [];
        this.download = function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var zip;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                zip = new jszip__WEBPACK_IMPORTED_MODULE_2__();
                this.compressedImages.forEach(function (obj) {
    ...
    ImageCompressComponent.prototype.selectFile = function () {
        var _this = this;
        this.downloadedFiles = this.fileService.getDownloadedFiles();
        var compressedFiles = [];
        this.downloadedFiles.forEach(function (image) {
            _this.api.compressImages(image, 40).subscribe(function (data) {
                compressedFiles.push(data.image);
                _this.fileService.compressedFiles.emit(compressedFiles);
            });
        });
    };
    ImageCompressComponent.prototype.selectFileLocallyUploaded = function (event) {
        var _this = this;
        var fileName;
    ...
    ImageCompressComponent.prototype.selectFileLocally = function () {
        var _this = this;
        var downloadedFiles = this.fileService.getDownloadedFiles();
        downloadedFiles.forEach(function (file) {
            var fileName = file.image_details.name;
            var reader = new FileReader();
            reader.onload = function (event) {
                _this.localUrl = event.target.result;
    ...
    ImageCompressComponent.prototype.compressFile = function (image, fileName) {
        ...
        this.imageCompress
            ...
            _this.compressedImages.push({ image: imageBlob, name: imageName });
        });
    };
    ...
    ImageCompressComponent.ctorParameters = function () { return [
        { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
...
var LocalFilePickerComponent = /** @class */ (function () {
    function LocalFilePickerComponent() {
    }
    LocalFilePickerComponent.prototype.ngOnInit = function () { };
    LocalFilePickerComponent.prototype.loadImages = function () { };
    ...
    return LocalFilePickerComponent;
}());
